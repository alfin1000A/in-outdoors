...
<head>
	<meta charset="utf-8" />
	<title>Inoutdoors | Penyewaan Alat Outdoors</title>
	<meta name="viewport" content="width=device-width, initial-scale=1.0">
	<meta content="A fully featured admin theme which can be used to build CRM, CMS, etc." name="description" />
	<meta content="Coderthemes" name="author" />
	<meta http-equiv="X-UA-Compatible" content="IE=edge" />
	<!-- App favicon -->
	<link rel="shortcut icon" href="<?php echo $base_url; ?>assets/images/LogoCamp.png">
				...
				<ul class="list-unstyled topnav-menu float-right mb-0">
					...
					<div class="logo-box">
						<a href="./" class="logo text-center">
							<span class="logo-lg">
								<!-- <img src="<?php echo $base_url; ?>assets/images/logo-rhino.png" alt="" height="60"> -->
								<span class="logo-lg-text-light"><img src="<?php echo $base_url; ?>assets/images/inoutdors.png" width="55px" style="margin-bottom: 10px;"> In Outdoors <span style="font-size: 11px;">Penyewaan Alat Outdoors</span></span>
							</span>
							<span class="logo-sm">
					...
					<div id="navigation">
						...
						<ul class="navigation-menu">
							...
							<?php if(empty($_SESSION['level'])) : ?>
								...
								<li class="has-submenu">
									<a href="<?php echo $base_url; ?>faq"><i class="fe-command"></i>Hubungi Kami </a>
								</li>
							<?php endif; ?>
							<?php if(in_array($_SESSION['level'], array('1'))) : ?>
								<li class="has-submenu">
									<a href="#"><i class="fa fa-database"></i> Input Data <div class="arrow-down"></div></a>
									<ul class="submenu">
										<li>
											<a href="<?php echo $base_url; ?>produk_list">Input Produk</a>
											<a href="<?php echo $base_url; ?>produk"><i class="fe-maximize"></i> Lihat Produk </a>
